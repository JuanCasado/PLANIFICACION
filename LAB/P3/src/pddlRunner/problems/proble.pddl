(define (problem probPlanetary) (:domain planetary) 
  ...
  (:init 
    ...
    (= (battery ROBOT0) 100) (= (maxBattery ROBOT0) 100) (= (rechargeRate ROBOT0) 0.01)
    ...
    (= (battery ROBOT1) 100) (= (maxBattery ROBOT1) 100) (= (rechargeRate ROBOT1) 0.01)
    (= (taskDuration ROBOT1 DRILL) 10) (= (taskDuration ROBOT1 TAKE_PHOTO) 20)
    (= (taskBurn ROBOT1 DRILL) 40) (= (taskBurn ROBOT1 TAKE_PHOTO) 10)


    (= (tasks LOCATION0 DRILL) 0)
    (= (tasks LOCATION1 DRILL) 0)
    (= (tasks LOCATION2 DRILL) 0)
    (= (tasks LOCATION3 DRILL) 0)
    (= (tasks LOCATION4 DRILL) 0)
    (= (tasks LOCATION5 DRILL) 0)
    (= (tasks LOCATION0 TAKE_PHOTO) 0)
    (= (tasks LOCATION1 TAKE_PHOTO) 0)
    (= (tasks LOCATION2 TAKE_PHOTO) 0)
    (= (tasks LOCATION3 TAKE_PHOTO) 0)
    (= (tasks LOCATION4 TAKE_PHOTO) 0)
    (= (tasks LOCATION5 TAKE_PHOTO) 0)
