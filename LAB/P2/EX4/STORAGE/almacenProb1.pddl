(define (problem almacenProb1) (:domain almacen)
(:objects 
    FastRobot - robot
    SlowRobot - robot
    N0 N1 - navmode
...
(:init
    ...
    (connected x6 y2 x6 y3) (connected x6 y3 x6 y4) (connected x6 y4 x6 y5) (connected x6 y5 x6 y6) 
    (connected x7 y2 x7 y3) (connected x7 y3 x7 y4) (connected x7 y4 x7 y5) (connected x7 y5 x7 y6) 
    ...
    (connected x6 y3 x6 y2) (connected x6 y4 x6 y3) (connected x6 y5 x6 y4) (connected x6 y6 x6 y5) 
    (connected x7 y3 x7 y2) (connected x7 y4 x7 y3) (connected x7 y5 x7 y4) (connected x7 y6 x7 y5) 
